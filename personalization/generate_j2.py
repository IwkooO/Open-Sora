...
# Force reload the sampling module to get our changes
import opensora.utils.sampling
importlib.reload(opensora.utils.sampling)
...
# Call prepare_ids with positional arguments
input_dict = prepare_ids(z, joint_embedding, joint_embedding)
